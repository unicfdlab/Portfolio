...
в авиации, судоростроении, автомобильной промышленности 
и прочих областях машиностроения. Существует множество
различных численных подходов для прогноза уравня акустического
...
* аналогия Фоукса-Вильямся Хокинга для прогноза шума, генерируемого
...
интерфейс к сторонним библиотекам (наприме **BEM++**).

На занятиях будут рассматриваться вопросы реализации
методов в рамках различных модулей библиотеки **libAcoustics**
и верификационные задачи: моделирование монополя (см. рис.), диполя
и тандема цилиндра в турбулентном потоке. После теоретической
